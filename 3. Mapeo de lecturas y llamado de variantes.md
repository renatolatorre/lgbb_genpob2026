...
Es recomendable detectar y eliminar los duplicados de lecturas, lo cual puede hacerse después del mapeo al genoma de referencia. En este tutorial usaremos el script `2-dedup.sh`. En el contenido cambiar los USERNAME a los nombres de grupo:
```bash
#!/bin/bash
...
# Comandos a ejecutar
input="XXX.FIELD_LAM34.ppa_v2.asm.bam"
