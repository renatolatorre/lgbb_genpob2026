...
cp /data/courses/course2026/course_files/scripts/* .
```
...
```bash
cat FIELD_LAM34.ppa_v2.asm.dedup.averagedepth
...
scp USERNAME@161.132.238.252:/data/USERNAME/3-mapeo_variantes/FIELD_LAM34.bam.bai* .
scp USERNAME@161.132.238.252:/data/courses/course2026/course_files/ppa_v2.asm.fasta* .
```
