...
awk 'NR==FNR{SNPs[$1]=$1; next} $1 in SNPs' LD_prun/$prefix.Chr.filt_"$window"_"$step"_"$threshold".prune.in $prefix.Chr.filt.beagle >> $prefix.Chr.filt.ldprune.beagle
...
paste sample_names.txt $prefix.ldpruned.filt.$maf.cov > $prefix.ldpruned.filt.$maf.names.cov
```
