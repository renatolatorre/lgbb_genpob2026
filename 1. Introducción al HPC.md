...
```bash
mkdir 1-hpc_linux 2-genome_qc logs
```
...
# Nombre del proceso:
#SBATCH --job-name=XXXXXXX_primerjob

# Proyecto: 
#SBATCH --account=XXXXXXXXXXXXX
#SBATCH --partition=normal # Nombre de la partición
...
# Archivos de salida
#SBATCH --output=/data/courses/course2026/XXXXXXXX/logs/primerjob_o%j # Nombre del archivo de salida stdout
#SBATCH --error=/data/courses/course2026/XXXXXXXX/logs/primerjob_e%j # Nombre del archivo de error stderr
...
# Comando a ejecutar
sed -n '15,50p' /data/course/course2026/course_files/WCVP_names.txt > /data/course/course2026/XXXXXXXX/1-hpc_linux/WCVP_names_15..50.txt
wc -l /data/course/course2026/XXXXXXXX/1-hpc_linux/WCVP_names_15..50.txt
sleep 60
